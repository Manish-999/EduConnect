...
namespace DAL.Methods
{
    public class CommonDAL : ICommonDAL
    {
        ...
        //        var schools = await connection.QueryAsync<SchoolCreateDto>(sql);
        //        return schools.ToList();
        //    }
        //    catch (Exception ex)
        //    {
        //        Console.WriteLine($"Error getting all schools: {ex.Message}");
        //        return new List<SchoolCreateDto>();
        //    }
        //}
        ...
        //        var teachers = await connection.QueryAsync<TeacherCreateDto>(sql);
        //        return teachers.ToList();
        //    }
        //    catch (Exception ex)
        //    {
        //        Console.WriteLine($"Error getting all teachers: {ex.Message}");
        //        return new List<TeacherCreateDto>();
        //    }
        //}
        ...
        //        var students = await connection.QueryAsync<StudentCreateDto>(sql);
